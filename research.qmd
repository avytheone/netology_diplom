...
В исследовании используется датасет (Cardiovascular Disease Dataset)[https://www.kaggle.com/datasets/sulianova/cardiovascular-disease-dataset], содержащий информацию о 70 000 пациентах. Данные предоставлены медицинской лабораторией и включают 11 признаков и целевую переменную наличия сердечно-сосудистого заболевания.
...
- **Random Forest**: Acc = 0.727
- **Logistic Regression**: Acc = 0.735
...
2. **Разработаны предиктивные модели**: обе модели (Logistic Regression и Random Forest) превышают требуемые пороги качества
